...
namespace App.Repositories
{
    public class ObjednaneZboziRepo
    {
        ...
        public List<KeyValuePair<ObjednaneZbozi, Zbozi>> Load()
        {
            var objednaneZboziList = new List<KeyValuePair<ObjednaneZbozi, Zbozi>>();

            string query = "SELECT * FROM v_objednane_zbozi";

            try
            {

                var data = _database.GetDataFromView("SELECT * FROM v_objednane_zbozi");
